...
SET target=magnetometer-stdlib
...
SET srcfolders=./src ./src/modules ./src/framework ./src/framework/platform %src_libs% %src_utils%
...
SET includes=-I. -I./inc -I./inc/modules -I./inc/framework -I./inc/framework/platform !includes_libs! !includes_utils!
